...
H5R__copy(const H5R_ref_priv_t *src_ref, H5R_ref_priv_t *dst_ref)
{
    ...
    H5MM_memcpy(&dst_ref->ref.obj.token, &src_ref->ref.obj.token, sizeof(H5O_token_t));
    ...
    size_t *token_size)
{
    ...
    if(obj_token) {
        ...
        H5MM_memcpy(obj_token, &ref->ref.obj.token, sizeof(H5O_token_t));
    }
    if(token_size)
    ...
    size_t token_size)
{
    ...
    H5MM_memcpy(&ref->ref.obj.token, obj_token, sizeof(H5O_token_t));
