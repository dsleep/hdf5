...
static herr_t H5O__visit_cb(hid_t group, const char *name, const H5L_info1_t *linfo,
    void *_udata);
 ...
 */
static herr_t
H5O__visit_cb(hid_t H5_ATTR_UNUSED group, const char *name, const H5L_info1_t *linfo,
    void *_udata)
{
